...
# CLIP onnx opset 18是我自行train後的分類模型，他能夠根據你給的主題prompt去把圖片進行分類，下圖是用CLIP 18去對我在網路上隨機尋找的1000張圖片進行分“多主題”分類的結果。Accuracy:94.56，顯示這模型對於Theme classicifation有很強大的能力。
